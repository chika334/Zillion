        ...
        <div hidden>
          <label>
            ...
            <input
              ...
              onChange={(e) =>
                this.setState({ includeMargin: e.target.checked })
              }
            />
          </label>
        </div>
        ...
        <div hidden>
          <label>
            ...
            <input
              ...
              onChange={(e) =>
                this.setState({ includeImage: e.target.checked })
              }
            />
          </label>
        </div>

        <fieldset hidden disabled={!this.state.includeImage}>
          ...
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  this.setState({ centerImage: e.target.checked })
                }
              />
            </label>
          </div>
