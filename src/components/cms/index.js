...
export default (editor, opts = {}) => {
  const options = {
    ...{
      ...
      help:
        "Select a template, enter page name, then click create. Use edit to modify the template.",

      // Show when no pages yet pages
      nopages:
        '<div style="display:flex;align-items:center;padding:50px;margin:auto;">No Pages Yet</div>',
